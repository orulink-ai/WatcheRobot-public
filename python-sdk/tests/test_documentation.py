...
def test_readmes_link_alpha_install_compatibility_resources_and_troubleshooting() -> None:
    for name in ("README.md", "README.zh-CN.md"):
        ...
        assert "SDK Control App" in readme
        assert "WatcheRobot main repository Releases" in readme or "WatcheRobot 主仓 GitHub Releases" in readme
        assert "firmware source build entrypoint" in readme or "固件源码构建入口" in readme
